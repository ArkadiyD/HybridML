...
class MyMaskablePPO(OnPolicyAlgorithm):
    """
    ...
    def train(self) -> None:
        ...
        for epoch in range(self.n_epochs):
            ...
            print(len(list(self.rollout_buffer.get(self.batch_size))))
            for rollout_data in self.rollout_buffer.get(self.batch_size):
                ...
                print(policy_loss, self.ent_coef * entropy_loss, self.vf_coef * value_loss)#, aux_los
                #exit(0)
